...
const pro = [
  // ------------ All Grand Projects----------------
  {
    ...
    p_name: "Wanderlust Traveling Site (Full-Stack Web Application) (PHASE-1)",
    // github link
    p_link: "https://github.com/MR-PRANAV/WANDERLUST",
    p_play: "https://mr-pranav.github.io/INFO.EVENT-MANAGEMENT/",
    p_tech: ["JavaScript", "Node.js", "Express.js", "MongoDB", "Mongoose", "EJS", "Passport.js", "Express-Session", "Connect-Mongo", "Method-Override"],
    p_info: `
      Developed a full-stack travel web application enabling users to list, review, and manage properties. Implemented secure authentication, session management, and error handling.   
              `,
      // IF WANT TO SHOW THE PROJECT LIVE THEN 'true' ELSE 'false' 
    p_isplay:false
  },
